...
import './confirm-announcement-post-page.css'

const ConfirmAnnouncementPostPage = (props) => {
    return (
        <div className="confirm-announcement-post-page-container">
            <Helmet>
                <title>Block Manager</title>
                <meta
                    property="og:title"
                    content="ConfirmAnnouncementPostPage - exported project"
                />
            </Helmet>
            <div className="confirm-announcement-post-page-confirm-announcement-post-page">
                <div className="confirm-announcement-post-page-menu">
                    <img
                        src="/playground_assets/line12351-fyk.svg"
                        alt="Line12351"
                        className="confirm-announcement-post-page-line1"
                    />
                    <img
                        src="/playground_assets/line22351-x0ju.svg"
                        alt="Line22351"
                        className="confirm-announcement-post-page-line2"
                    />
                    <img
                        src="/playground_assets/line32351-ydah.svg"
                        alt="Line32351"
                        className="confirm-announcement-post-page-line3"
                    />
                </div>
                <span className="confirm-announcement-post-page-text">
          <span>Anunțul a fost postat cu succes!</span>
        </span>
                <div className="confirm-announcement-post-page-group11">
                    <Link to="/home" className="confirm-announcement-post-page-navlink">
                        <img
                            src="/playground_assets/rectangle142351-pq6d-400h.png"
                            alt="Rectangle142351"
                            className="confirm-announcement-post-page-rectangle14 button"
                        />
                    </Link>
                    <span className="confirm-announcement-post-page-text2">
            <span>Înapoi la pagina de start</span>
          </span>
                </div>
                <div className="confirm-announcement-post-page-frame5"></div>
                <img
                    alt="image"
                    src="/playground_assets/logo-200h.png"
                    className="confirm-announcement-post-page-image"
                />
                <div className="confirm-announcement-post-page-butoane-bara">
                    <Link to="/home" className="confirm-announcement-post-page-navlink1">
                        <img
                            id="homebtn"
                            ...
                            className="confirm-announcement-post-page-i-m-a-g-e1976053homehomepagehomepagehomepagesicon1 button"
                        />
                    </Link>
                    ...
                    <Link to="/problems-page" className="home-navlink2">
                        <img
                            ...
                            className="confirm-announcement-post-page-i-m-a-g-e4092561envelopemailmobileuimessageemailicon1 button"
                        />
                    </Link>
                </div>
            </div>
...
export default ConfirmAnnouncementPostPage
